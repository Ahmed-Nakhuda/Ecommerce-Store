...
function Checkout() {
    ...
    }, [firstName, lastName, email, phone, address, city, province, cardNumber, nameOnCard, expirationDate, securityCode]);
        ...
        <div className="accordion">
            <Accordion defaultExpanded>
                <AccordionSummary
                    ...
                    id="panel1-header"
                >
                    <Typography color={'white'} variant="h5" className="accordionHeading">Shipping Details</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <form id="checkoutForm" className="form">
                        ...
                        <div className="formGroup">
                            <label className='checkoutFormLabel' htmlFor="phone">Phone Number:</label>
                            <TextField
                                className="textbox"
                                variant="outlined"
                                name="phone"
                        ...
                        <div className="formGroup">
                            <div className="selectContainer">
                                ...
                                <Select styles={customStyles} options={canadianCities} onChange={(selectedOption) => setCity(selectedOption.value)} />
                            </div>
                        </div>
                        <div className="formGroup">
                            <div className="selectContainer">
                                <label id='province' htmlFor="address">Province:</label>
                                <Select styles={customStyles} options={provinces} onChange={(selectedOption) => setProvince(selectedOption.value)} />
                            </div>
                        </div>
                        {!buttonHidden && <button type="button" id="continueButton" disabled={!nextButtonEnabled} onClick={() => { handleNextButtonClick(); handleClick(); }}>Continue to Payment</button>}
                    </form>
                </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={paymentAccordionExpanded} disabled={!paymentAccordionDisabled}>
                <AccordionSummary
                    ...
                    id="panel2-header"
                >
                    <Typography color={'white'} variant="h5">Payment</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <form id="checkoutForm" className="form">
                        <div className="formGroup">
                        ...
                        <div className="formGroup">
                            <label id='nameOnCard' htmlFor="nameOnCard">Name on Card:</label>
                            <TextField
                                className="textbox"
                                variant="outlined"
                                name="nameOnCard"
                        ...
                        <div className="formGroup">
                            <label id='expirationDate' htmlFor="expirationDate">Expiration Date:</label>
                        ...
                        <div className="formGroup">
                            <label id='securityCode' htmlFor="nameOnCard">Security Code:</label>
                            <TextField
                        ...
                        <Link to='/confirmation'>
                            <button disabled={!placeOrderButtonEnabled} id='placeOrderButton'>Place Order</button>
                        </Link>
                    </form>
                </AccordionDetails>
            </Accordion>
